    ...
    <section className="relative overflow-hidden pt-32 pb-20 sm:pt-40 lg:pb-28">
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-14 px-5 sm:px-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          >
            eKS detects {" "}
            <span className="font-semibold text-ink-700">forged documents</span>,{" "}
            <span className="font-semibold text-ink-700">duplicate identities</span> and{" "}
            <span className="font-semibold text-ink-700">behavioral fraud</span> in
            real time - turning onboarding into a fortress without the friction.
          </motion.p>
...
function HeroVisual() {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[2rem] border border-ink-100 bg-white p-5 shadow-[0_30px_80px_-30px_rgba(16,46,14,0.35)]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-bold text-ink-900">Identity Scan</p>
              <p className="text-[11px] text-ink-400">Session #VR-90241</p>
            </div>
          </div>
      ...
      >
        <RiskScoreCard score={18} size={120} compact showTier={false} label="Risk" />
      </motion.div>
      ...
      >
        ...
        <div>
          ...
          <p className="text-[11px] text-ink-400">in 8.4 seconds</p>
        </div>
      </motion.div>
